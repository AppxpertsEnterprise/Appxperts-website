          ...
          <Row>
            <Col lg={6}>
              <div className="contact-two__info">
                ...
                {/* ✅ FIXED: Wrapped <ul> inside <div> instead of <p> */}
                <div className="contact-two__info__box-wrapper">
                  <ul>
                    {infoBoxs.map(({ id, icon, text, title, href, subHref }) => (
                      <li key={id} className="contact-two__info__box">
                        ...
                        <div className="contact-two__info__box__text">
                          {href && subHref ? (
                ...
                <div className="contact-two__info__social">
                  <h5 className="contact-two__info__social__title">Follow Social:</h5>
